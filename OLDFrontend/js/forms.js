...
// Set up the incident report form, including validation and submission
function initReportForm() {
  ...
  form.addEventListener('submit', function (e) {
    ...
    const isLoggedIn = sessionStorage.getItem('marsad_user_token'); // Mock token
    if (!isLoggedIn) {
